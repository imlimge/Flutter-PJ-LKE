...
// 람다함수 연습
showTxt('"아직 신에게는 12척의 배가 남았습니다"  이 대사가 나오는 이순인의 전투는  ${retVal(leeFight[0])}');
...
showTxt('이순신의 부하 중 이순신이 있었다. 그는 전투전에 너무 긴장되어서 구구단을 외웄다. 9단');
...
showTxt('공유의 취미는 ${recommActor['공유']?['취미']}다. 사는곳은 ${recommActor['공유']?['사는곳']}다 공유의 자동차는${recommActor['공유']?['자동차']??"정보없음"}');
